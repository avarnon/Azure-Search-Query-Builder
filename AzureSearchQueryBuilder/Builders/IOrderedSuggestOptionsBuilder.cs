...
{
    /// <summary>
    /// An interface representing an ordered <see cref="SuggestOptions"/> builder.
    /// </summary>
    /// <typeparam name="TModel">The type of the model representing the search index documents.</typeparam>
    public interface IOrderedSuggestOptionsBuilder<TModel> : IOrderlessSuggesOptionsBuilder<TModel>
    {
        /// <summary>
        ...
        IOrderedSuggestOptionsBuilder<TModel> WithSelect<TProperty>(Expression<PropertyLambdaDelegate<TModel, TProperty>> lambdaExpression);
