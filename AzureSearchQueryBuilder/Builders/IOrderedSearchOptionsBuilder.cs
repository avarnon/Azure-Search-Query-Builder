...
{
    /// <summary>
    /// An interface representing an ordered <see cref="SearchOptions"/> builder.
    /// </summary>
    /// <typeparam name="TModel">The type of the model representing the search index documents.</typeparam>
    public interface IOrderedSearchOptionsBuilder<TModel> : IOrderlessSearchOptionsBuilder<TModel>
    {
        /// <summary>
        ...
        /// <returns>the updated builder.</returns>
        IOrderedSearchOptionsBuilder<TModel> WithQueryType(SearchQueryType queryType);
